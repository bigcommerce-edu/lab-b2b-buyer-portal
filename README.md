...
```shell
degit https://github.com/bigcommerce-edu/lab-b2b-buyer-portal.git#crm-pre <directory-name>
```

[Completed Lab 6 state](https://github.com/bigcommerce-edu/lab-b2b-buyer-portal/tree/crm-post)

* [Step 1 - Perform token exchange](https://github.com/bigcommerce-edu/lab-b2b-buyer-portal/compare/crm-01-pre...crm-01-post?diff=split)
* [Step 2 - Fetch ERP order data](https://github.com/bigcommerce-edu/lab-b2b-buyer-portal/compare/crm-02-pre...crm-02-post?diff=split)
* [Step 3 - Add status column](https://github.com/bigcommerce-edu/lab-b2b-buyer-portal/compare/crm-03-pre...crm-03-post?diff=split)

[Full Lab 6 diff](https://github.com/bigcommerce-edu/lab-b2b-buyer-portal/compare/crm-pre...crm-post?diff=split)
