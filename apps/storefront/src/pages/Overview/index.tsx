...
import { validatePermissionWithComparisonType } from "@/utils";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Accordion
            onChange={(e, isExpanded) => setOrdersOpen(isExpanded)}
          >
            <AccordionSummary
        ...
        >
          <Accordion
            onChange={(e, isExpanded) => setInvoicesOpen(isExpanded)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
            >
        ...
        >
          <Accordion
            onChange={(e, isExpanded) => setShoppingListsOpen(isExpanded)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
            >
        ...
        >
          <Accordion
            onChange={(e, isExpanded) => setQuotesOpen(isExpanded)}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
            >
